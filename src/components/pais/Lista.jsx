...
import { deletePais, obtenerPais } from '../../actions/PaisAction';
                    ...
                    {data.valor.map((exam) => (
                      <TableRow key={exam.idPais}>
                        ...
                        <TableCell>
                          ...
                          <IconButton aria-label="delete" onClick={handleClickOpen} onClickCapture={dato =exam.idPais} color="error">
                            <DeleteIcon />
                          </IconButton>
